...
const columns = [
  ...
  { key: "a", label: "INDOOR / OUTDOOR 20HRS DAILY" },
  { key: "b", label: "INDOOR / OUTDOOR 20HRS DAILY" },
];

const rows = [
  { label: "Rise", a: "<6m", b: "<27m" },
  ...
  {
    label: "Balustrade",
    a: "Tempered Glass / SS Balustrade#",
    b: "Tempered Glass / SS Balustrade#",
  },
  { label: "Handrail Bracket", a: "Stainless Steel", b: "Stainless Steel" },
  { label: "Handrail", a: "Black", b: "Black" },
  { label: "Balustrade Height", a: "1000mm", b: "1000mm" },
  {
    label: "Illumination",
